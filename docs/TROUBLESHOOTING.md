# 🔧 Troubleshooting Guide — GitOps Secrets Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-gitops-secrets/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/gitops-secrets/)
