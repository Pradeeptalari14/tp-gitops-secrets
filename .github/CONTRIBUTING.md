...
Thank you for your interest in improving the **GitOps Secrets Studio** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-gitops-secrets.git
...
Generated configurations come from the **[GitOps Secrets Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/gitops-secrets/)**.
